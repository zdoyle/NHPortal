...
namespace NHPortal.Classes.Reference
{
    ...
    public class PostingTypes
    {
        ...
        public static PostingType Find(char value)
        {
    ...
    {
        /// <summary>Instantiates a new instance of the PostingType class.</summary>
        /// <param name="dr">DataRow containing record information from the database.</param>
        public PostingType(DataRow dr)
        {
