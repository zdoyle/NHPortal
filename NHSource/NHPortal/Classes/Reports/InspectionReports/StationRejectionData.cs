...
{
    public class StationRejectionData : IReportData
    {
        public StationRejectionData()
        {
            BaseReport = BaseReportMaster.StationRejection;
        }
        ...
        public string BuildSQL()
        {
            ...
            builder.AppendLine(" SELECT DISTINCT STATIONID,");
            builder.Append(String.Format(BaseReportMaster.QUERY_REPORT, "STATIONID"));
            builder.Append("{0}");
            builder.AppendLine(" ORDER BY DECODE((OVERALL_PASS + OVERALL_REJECT + OVERALL_CORRECTED),0,0,OVERALL_REJECT/(OVERALL_PASS + OVERALL_REJECT + OVERALL_CORRECTED)) DESC, STATIONID ");
