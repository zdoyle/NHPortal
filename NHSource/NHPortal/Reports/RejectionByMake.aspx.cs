...
{
    public partial class RejectionByMake : PortalPage
    {
        private BaseReport ReportData = BaseReportMaster.RejectionByMake;
        PredefinedQueryType queryType = PredefinedQueryType.Make;
        ...
        {
            string filterText = this.txtMake.Text.Trim().ToUpper().Replace(",", String.Empty);
