...
{
    public partial class RejectionByInspector : PortalPage
    {
        private BaseReport ReportData = BaseReportMaster.RejectionByInspector;
        PredefinedQueryType queryType = PredefinedQueryType.InspectorID;
        ...
        {
            string filterText = this.txtInspectorID.Text.Trim().ToUpper().Replace(",", String.Empty);
        ...
        private void SetMetaData(string filterText)
        {
            if (Master.UserReport != null)
            {
                ...
                {
                    Master.UserReport.MetaData.Add("Inspector", filterText);
                }
            }
        }
        ...
        private void LoadFavorite()
        {
            ...
            if (fav != null)
            {
                foreach (var c in fav.Criteria)
                {
                    ...
                    {
                        case "INSPECTOR":
                            this.txtInspectorID.Text = c.Value;
                            break;
                    }
                }
            }
